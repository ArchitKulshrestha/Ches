...
const eurekaB = [
...

  {
    ...
    solution:"The Problems About Plastics Are Evident And The Damage It Is Causing By Sitting In Land Fills And By Being Uncollected Doesn't Seem To Stop. We, The Students By The Help Of Our Mentor Want To Overcome This Situation To A Large Extent By Providing A Value To Non Recycled Plastic Through The Process Of Pyrolysis And Converting Them To Fuel."
  },
  {
    team:"Power9",
    statement:"Graphene Oxide: A promising Nano-material for energy and Environmental applications.",
    solution:"Graphene is a useful nano-material for environmental applications and in recent times the pollution level is increasing which is really harmful for the environment. the surface functional groups like hydroxyl, Epoxy etc. make Graphene oxide an excellent candidate in coordinating with other materials or molecules."
  },
  {
    team:"Novo Rudolfs",
    
    statement:"Innovation in Biodiesel production",
    solution:"Synthesis and characterization of biodiesel from waste cooking oil. We will be testing for various properties of synthesised oil And other blends. Proposal of an improved catalytic method for the production And emission reduction."
  ...
  },
  {
    ...
    solution:"Analysis and Simulation of Chemical Reactions for Obtaining Dodecil-Benzene From N-Dodecane as an Alternative to Kerosene"
  }
...
function Eureka2() {
  return (
    ...
    <h1 className='text-[40px] md:text-[65px] pt-[6rem] mb-5 px-3 text-center font-bold'>Eureka 2.0 Archives</h1>
