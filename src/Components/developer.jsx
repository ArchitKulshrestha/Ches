        ...
        {Developers.map((developer) => (
          <Tilt
            ...
            <div className="w-full  rounded-[10px]  ">
              <div className="w-[96%] sm:w-[180px] min-h-[100px]  hover:shadow-text-500/70 backdrop-blur-[10px] bg-background-900/70 rounded-[20px] text-[#f7ebfa]  p-4 hover:shadow-lg">
                <p className=" font-semibold text-lg ">{developer.name}</p>
